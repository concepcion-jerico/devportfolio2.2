...
function generate_new_transaction_number() {
	...
	for($i=0; $i<16; $i++) {
		$index = rand(0,15); //generate a random number from 0-15
...
$subject = 'JconStore - Order Confirmation';
...
try {
    ...
    //Recipients
    $mail->setFrom($staff_email, 'JconStore');
    ...
    $transaction ->setAmount($amount)
                ...
                ->setDescription('Payment for Jconstore Purchase')
                ->setInvoiceNumber(uniqid("Jconstore_"));
