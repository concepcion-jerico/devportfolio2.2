...
$new_order_query = "INSERT INTO orders(user_id, transaction_code, purchase_date, total, status_id, payment_mode_id) VALUES ('$user_id', '$trans_code', '$purchase_date', 0, '$status_id', '$payment_mode_id');";
